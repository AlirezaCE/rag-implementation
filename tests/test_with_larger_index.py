#!/usr/bin/env python3
"""
Test RAG with larger FAISS index (10k articles).
"""
...
print("Loading FAISS index (10k articles)...")
index = FAISSIndex.load("./data/index_10k/index.faiss")

# Load passages
print("Loading passages...")
passages = []
with open("./data/index_10k/passages.jsonl", 'r', encoding='utf-8') as f:
    for line in f:
...
print("\n" + "="*60)
print("Testing RAG with 10k article index")
print("="*60 + "\n")
